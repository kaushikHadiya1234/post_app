                  ...
                  children: [
                    ...
                    Container(
                        ...
                        child: propath == null
                            ...
                            : ClipRRect(
                                borderRadius: BorderRadius.circular(28),
                                child: Image.file(File('$propath'),fit: BoxFit.fill,))),
                  ],
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceAround,
                ...
                FloatingActionButton.extended(
                  onPressed: () {
                    if(txtkey.currentState!.validate())
                      {
                        DMart d =DMart(img1:propath,img2: path,name: txtname.text,no: txtno.text,web: txtweb.text);
                        Navigator.pushNamed(context, 'dm',arguments: d);
                      }
                  },
                  label: Text('Submit'),
                )
